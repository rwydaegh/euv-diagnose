...
The constrained search asks for one degree of phase separation. Its pair of stacks is an ambiguity example under assumed intensity weights, not an uncertainty interval. Run `scripts/verify_continuous_witness.py` to check both candidates with 40 explicitly expanded periods.
